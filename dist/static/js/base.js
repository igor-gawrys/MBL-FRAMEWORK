...
const blade = ( template, app, route ) => {
 ...
 /* functions */ const componentIndex = () => {  return { data:{ number: 1, name: "Igor" }, methods:{ add: () => { app.data.number = Math.random( 10 * 100 ) / 100000; } } } } 
...
window.onload = () => {
 ...
 /* routes */ router( {"name":"Index","path":"/","component":"componentIndex","body":["<body><img src=\"https://cdn.pixabay.com/photo/2015/11/07/11/03/satellite-1030779_960_720.jpg\"> <div class=\"container text-white\" m-ss0dzkb=\"\"> <h1 class=\"text-center\"> MBL </h1> <p> Your reactive framework installed </p> <p> Example </p> <p> {{ app.data.number }} </p> <input type=\"text\" m-model=\"name\"> </div> </body>","<img src=\"https://cdn.pixabay.com/photo/2015/11/07/11/03/satellite-1030779_960_720.jpg\"> <div class=\"container text-white\" m-ss0dzkb=\"\"> <h1 class=\"text-center\"> MBL </h1> <p> Your reactive framework installed </p> <p> Example </p> <p> {{ app.data.number }} </p> <input type=\"text\" m-model=\"name\"> </div> "]} );
